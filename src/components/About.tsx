    ...
    <section id="about" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-800 mb-4">About SimpuFix Solution</h2>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-700">Certified professionals with years of experience</span>
              </div>
              <div className="flex items-center space-x-3">
                <CheckCircle className="text-green-500" size={20} />
                <span className="text-gray-700">Customized solutions for unique business needs</span>
              </div>
              <div className="flex items-center space-x-3">
                <CheckCircle className="text-green-500" size={20} />
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg">
          <h3 className="text-2xl font-bold text-gray-800 mb-6 text-center">Why Choose SimpuFix Solution?</h3>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold text-gray-800 mb-2">Customized Solutions</h4>
              <p className="text-gray-600 text-sm">
