      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Ready to transform your business with enterprise-grade IT solutions? Contact us for a free 
            consultation and discover how we can enhance your operational efficiency.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="bg-gray-50 rounded-2xl p-8">
            <h3 className="text-2xl font-bold text-gray-800 mb-6">Request Free Consultation</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="internet">Internet Provisioning</option>
                    <option value="network">Network Installation</option>
                    <option value="iptv">IPTV Services</option>
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-800">Business Phone</h4>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Available 24/7, 365 days a year</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@simpufixsolution.com</p>
                    <p className="text-gray-600">support@simpufixsolution.com</p>
                  </div>
                </div>
            ...
            <div className="bg-blue-50 rounded-xl p-6">
              <h4 className="font-bold text-gray-800 mb-4">Consultation Process</h4>
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700">Comprehensive site assessment</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
                    3
                  </div>
                  <span className="text-gray-700">Detailed proposal with timeline</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
                    4
                  </div>
                  <span className="text-gray-700">Professional implementation</span>
                </div>
              </div>
            </div>
